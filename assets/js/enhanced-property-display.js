/**
 * 🏢 سمسار طلبك - نظام عرض العقارات المحسن (النسخة النهائية الكاملة)
 * Enhanced Property Display System (Final Full Version)
 * 
 * الميزات المدمجة:
...
class EnhancedPropertyDisplay {
  ...
  highlightLastViewedCard() {
    ...
    if (cardToHighlight) {
      ...
      localStorage.removeItem('lastViewedCard'); // Remove immediately after highlighting
    }
  }
