/**
 * 🏢 سمسار طلبك - نظام عرض العقارات المحسن (النسخة النهائية الكاملة v3.5 - مع إصلاح الفرز)
 */
...
const additionalStyles = `
  <style>
    /* ... (الأنماط الإضافية تبقى كما هي) ... */
  </style>
`;
if (!document.getElementById('enhanced-requests-styles')) { // Should be a unique ID
