...
class EnhancedPropertyDisplay {
  ...
  // ===================================================================
  // 1. التهيئة والإعداد الأولي (Initialization & Setup)
  // ===================================================================
  ...
  setupElements() {
    ...
    if (!this.container || !this.filterContainer) {
      throw new Error('العناصر الأساسية (properties-container, filter-buttons) غير موجودة في DOM.');
    }
  ...
  // ===================================================================
  // 2. واجهة المستخدم والتفاعل (UI & Interaction)
  // ===================================================================
  ...
  setupEventListeners() {
    ...
    window.addEventListener('offline', () => this.showNotification('⚠️ انقطع الاتصال بالإنترنت', 'warning'));
    window.addEventListener('error', (event) => {
      console.error('خطأ JavaScript غير متوقع:', event.error);
  ...
  // ===================================================================
  // 4. تحميل وعرض البيانات (Data Loading & Display)
  // ===================================================================
  ...
  async loadCategory(category) {
    ...
    try {
      ...
      console.error(`خطأ في تحميل بيانات الفئة ${category}:`, error);
  ...
  // ===================================================================
  // 5. إنشاء كروت العقارات والتفاعل معها (Property Card Creation & Interaction)
  // ===================================================================
  ...
  // ===================================================================
  // 6. حالات الواجهة (UI States - Loading, Empty, Error)
  // ===================================================================
  ...
  // ===================================================================
  // 7. الميزات الإضافية (Extra Features & Accessibility)
  // ===================================================================
  ...
  // ===================================================================
  // 8. الدوال المساعدة (Utility & Helper Functions)
  // ===================================================================
