/**
 * نظام تحميل تفاصيل العقار (الإصدار النهائي v9.0 - مع نظام الصور الداخلي)
 */
...
// (دوال showErrorState و copyToClipboard تبقى كما هي)
...
function updateSeoTags(prop, propertyId) {
  ...
  // 2. بناء رابط يستدعي "الدالة الخادمة" الجديدة التي أنشأناها
...
// (دالة renderPropertyDetails تبقى كما هي في نسختها الناجحة الكاملة)
function renderPropertyDetails(prop, container, propertyId) {
    // الكود الكامل لهذه الدالة يبقى كما هو في آخر نسخة ناجحة
