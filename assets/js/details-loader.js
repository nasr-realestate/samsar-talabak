/**
 * نظام تحميل تفاصيل العقار (الإصدار النهائي الكامل v8.4 - مع نظام الصور التلقائي)
 */
...
function updateSeoTags(prop, propertyId) {
  ...
  const imageTitle = prop.title || 'عرض عقاري مميز';
  ...
  const autoShareImage = `https://og-image.vercel.app/${encodedTitle}?price=${encodedPrice}&area=${encodedArea}&site_name=aqarnasr.netlify.app&theme=dark&md=1&fontSize=75px`;
